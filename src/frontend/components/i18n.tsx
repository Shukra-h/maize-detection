...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    "detector.authCheckingTitle": "Checking access",
    "detector.authCheckingCopy": "We are checking your session before opening the detection workspace.",
    "detector.authRequiredTitle": "Login required",
    "detector.authRequiredCopy": "Create an account or log in before using the maize detection workspace.",
    "detector.authMissingTitle": "Auth is not configured",
    "detector.authMissingCopy": "Supabase keys are missing, so this protected detection route cannot be opened yet.",
    "detector.backHome": "Back to home",
    ...
    "detector.rawModelResult": "Raw model result",
    "detector.feedbackAdjustedResult": "Prediction result",
    "detector.rawModelOutput": "Raw model output",
    "detector.rawModelProbabilities": "Raw model probabilities",
    "detector.rawConfidence": "Raw model confidence",
    "detector.adjustedConfidence": "Confidence",
    "detector.decision": "Decision",
    "detector.decisionAccepted": "Accepted",
    "detector.decisionLikely": "Likely",
    "detector.decisionRejected": "Rejected",
    "detector.decisionUnknown": "Unknown",
    "detector.feedbackTitle": "Review this prediction",
    "detector.feedbackCopy": "Was the displayed prediction correct for this image?",
    "detector.feedbackYes": "Yes",
    "detector.feedbackNo": "No",
    "detector.feedbackCorrectClassLabel": "What should it be?",
    "detector.feedbackClassPlaceholder": "Select the correct class",
    "detector.feedbackClassUnknown": "Unknown / not maize",
    "detector.feedbackTrainingConsent": "Include this image for future model training",
    "detector.feedbackTrainingConsentCopy": "Only the API stores the image when this is checked; otherwise it saves the correction without the image.",
    "detector.feedbackSubmit": "Submit feedback",
    "detector.feedbackSubmitting": "Submitting feedback",
    "detector.feedbackSaved": "Feedback submitted and saved with this history item.",
    "detector.feedbackApiOnly": "Feedback submitted to the API, but local history could not be updated.",
    "detector.feedbackErrorGeneric": "Could not submit feedback.",
    "detector.feedbackErrorChooseAnswer": "Choose yes or no before submitting.",
    "detector.feedbackErrorChooseClass": "Choose the correct class before submitting.",
    "detector.feedbackHistoryCorrect": "Feedback: prediction marked correct.",
    "detector.feedbackHistoryCorrection": "Feedback: corrected to {class}.",
  ...
  ha: {
    ...
    "detector.authCheckingTitle": "Ana duba izini",
    "detector.authCheckingCopy": "Muna duba zaman shigarka kafin buɗe wurin gano cuta.",
    "detector.authRequiredTitle": "Ana buƙatar shiga",
    "detector.authRequiredCopy": "Ƙirƙiri asusu ko shiga kafin amfani da wurin gano cutar masara.",
    "detector.authMissingTitle": "Ba a saita shiga ba",
    "detector.authMissingCopy": "Maɓallan Supabase ba su nan, don haka ba za a iya buɗe wannan hanya mai kariya ba tukuna.",
    "detector.backHome": "Koma gida",
    ...
    "detector.rawModelResult": "Sakamakon samfurin asali",
    "detector.feedbackAdjustedResult": "Sakamakon hasashe",
    "detector.rawModelOutput": "Fitowar samfurin asali",
    "detector.rawModelProbabilities": "Yiwuwar samfurin asali",
    "detector.rawConfidence": "Amincewar samfurin asali",
    "detector.adjustedConfidence": "Amincewa",
    "detector.decision": "Hukunci",
    "detector.decisionAccepted": "An karba",
    "detector.decisionLikely": "Mai yiwuwa",
    "detector.decisionRejected": "An ki",
    "detector.decisionUnknown": "Ba a sani ba",
    "detector.feedbackTitle": "Duba wannan hasashe",
    "detector.feedbackCopy": "Shin hasashen da aka nuna daidai ne ga wannan hoto?",
    "detector.feedbackYes": "Eh",
    "detector.feedbackNo": "A'a",
    "detector.feedbackCorrectClassLabel": "Me ya kamata ya kasance?",
    "detector.feedbackClassPlaceholder": "Zabi ajin da ya dace",
    "detector.feedbackClassUnknown": "Ba a sani ba / ba masara ba",
    "detector.feedbackTrainingConsent": "A hada wannan hoto don horas da samfurin nan gaba",
    "detector.feedbackTrainingConsentCopy": "API ne kawai zai adana hoton idan an zabi wannan; idan ba haka ba, zai ajiye gyaran ba tare da hoton ba.",
    "detector.feedbackSubmit": "Aika martani",
    "detector.feedbackSubmitting": "Ana aika martani",
    "detector.feedbackSaved": "An aika martani kuma an ajiye shi da wannan tarihin.",
    "detector.feedbackApiOnly": "An aika martani zuwa API, amma ba a iya sabunta tarihin gida ba.",
    "detector.feedbackErrorGeneric": "Ba a iya aika martani ba.",
    "detector.feedbackErrorChooseAnswer": "Zabi eh ko a'a kafin aikawa.",
    "detector.feedbackErrorChooseClass": "Zabi ajin da ya dace kafin aikawa.",
    "detector.feedbackHistoryCorrect": "Martani: an nuna hasashen daidai.",
    "detector.feedbackHistoryCorrection": "Martani: an gyara zuwa {class}.",
  ...
  yo: {
    ...
    "detector.authCheckingTitle": "Ń ṣàyẹ̀wò ìwọlé",
    "detector.authCheckingCopy": "A ń ṣàyẹ̀wò ìwọlé rẹ kí a tó ṣí ibùdó ìwádìí.",
    "detector.authRequiredTitle": "Ìwọlé jẹ dandan",
    "detector.authRequiredCopy": "Ṣẹ̀dá àkọọlẹ tàbí wọlé kí o tó lo ibùdó ìwádìí agbado.",
    "detector.authMissingTitle": "A kò ṣètò ìwọlé",
    "detector.authMissingCopy": "Àwọn bọtini Supabase kò sí, nítorí náà a kò lè ṣí ọna ìwádìí tó ní ààbò yìí.",
    "detector.backHome": "Padà sí ilé",
    ...
    "detector.rawModelResult": "Abajade awoṣe gangan",
    "detector.feedbackAdjustedResult": "Abajade asọtẹ́lẹ̀",
    "detector.rawModelOutput": "Ohun tí awoṣe gangan dá padà",
    "detector.rawModelProbabilities": "Ìṣeese awoṣe gangan",
    "detector.rawConfidence": "Ìgbẹ́kẹ̀lé awoṣe gangan",
    "detector.adjustedConfidence": "Ìgbẹ́kẹ̀lé",
    "detector.decision": "Ìpinnu",
    "detector.decisionAccepted": "A gba",
    "detector.decisionLikely": "Ó ṣeé ṣe",
    "detector.decisionRejected": "A kọ",
    "detector.decisionUnknown": "A kò mọ̀",
    "detector.feedbackTitle": "Ṣàyẹ̀wò asọtẹ́lẹ̀ yìí",
    "detector.feedbackCopy": "Ṣé asọtẹ́lẹ̀ tí a fi hàn tọ́ fún àwòrán yìí?",
    "detector.feedbackYes": "Bẹ́ẹ̀ ni",
    "detector.feedbackNo": "Rárá",
    "detector.feedbackCorrectClassLabel": "Kí ni ó yẹ kí ó jẹ́?",
    "detector.feedbackClassPlaceholder": "Yan kilasi tó tọ́",
    "detector.feedbackClassUnknown": "A kò mọ̀ / kì í ṣe agbado",
    "detector.feedbackTrainingConsent": "Fi aworan yii kun fun ikẹkọ awoṣe nigbamii",
    "detector.feedbackTrainingConsentCopy": "API nikan ni yoo fi aworan pamọ ti eyi ba yan; bibẹẹkọ, yoo fi atunṣe pamọ laisi aworan.",
    "detector.feedbackSubmit": "Fi ìdáhùn ránṣẹ́",
    "detector.feedbackSubmitting": "Ń fi ìdáhùn ránṣẹ́",
    "detector.feedbackSaved": "A ti fi ìdáhùn ránṣẹ́, a sì fi pamọ́ pẹ̀lú ohun ìtàn yìí.",
    "detector.feedbackApiOnly": "A ti fi ìdáhùn ránṣẹ́ sí API, ṣùgbọ́n a kò le tún ìtàn abẹ́lé ṣe.",
    "detector.feedbackErrorGeneric": "A kò le fi ìdáhùn ránṣẹ́.",
    "detector.feedbackErrorChooseAnswer": "Yan bẹ́ẹ̀ ni tàbí rárá kí o tó fi ránṣẹ́.",
    "detector.feedbackErrorChooseClass": "Yan kilasi tó tọ́ kí o tó fi ránṣẹ́.",
    "detector.feedbackHistoryCorrect": "Ìdáhùn: a samisi asọtẹ́lẹ̀ pé ó tọ́.",
    "detector.feedbackHistoryCorrection": "Ìdáhùn: a túnṣe sí {class}.",
  ...
  ig: {
    ...
    "detector.authCheckingTitle": "Na-enyocha ohere",
    "detector.authCheckingCopy": "Anyị na-enyocha nnọkọ gị tupu imepe ebe nchọpụta.",
    "detector.authRequiredTitle": "Ịbanye dị mkpa",
    "detector.authRequiredCopy": "Mepụta akaụntụ ma ọ bụ banye tupu iji ebe nchọpụta ọka.",
    "detector.authMissingTitle": "Ahazibeghị nbanye",
    "detector.authMissingCopy": "Igodo Supabase adịghị, ya mere ụzọ nchọpụta a echedoro agaghị emeghe ugbu a.",
    "detector.backHome": "Laghachi n'ụlọ",
    ...
    "detector.rawModelResult": "Nsonaazụ model mbụ",
    "detector.feedbackAdjustedResult": "Nsonaazụ amụma",
    "detector.rawModelOutput": "Ihe model mbụ wepụtara",
    "detector.rawModelProbabilities": "Ohere model mbụ",
    "detector.rawConfidence": "Ntụkwasị obi model mbụ",
    "detector.adjustedConfidence": "Ntụkwasị obi",
    "detector.decision": "Mkpebi",
    "detector.decisionAccepted": "Anabatara",
    "detector.decisionLikely": "O yikarịrị",
    "detector.decisionRejected": "Ajụrụ",
    "detector.decisionUnknown": "Amaghị",
    "detector.feedbackTitle": "Nyochaa amụma a",
    "detector.feedbackCopy": "Amụma egosiri ọ ziri ezi maka foto a?",
    "detector.feedbackYes": "Ee",
    "detector.feedbackNo": "Mba",
    "detector.feedbackCorrectClassLabel": "Kedu ihe o kwesịrị ịbụ?",
    "detector.feedbackClassPlaceholder": "Họrọ klas ziri ezi",
    "detector.feedbackClassUnknown": "Amaghị / ọ bụghị ọka",
    "detector.feedbackTrainingConsent": "Tinye foto a maka ikuzi model n'ọdịnihu",
    "detector.feedbackTrainingConsentCopy": "Naanị API ga-echekwa foto ahụ ma ọ bụrụ na ahọrọ nke a; ma ọ bụghị ya, ọ ga-echekwa mmezi ahụ na-enweghị foto.",
    "detector.feedbackSubmit": "Zipu nzaghachi",
    "detector.feedbackSubmitting": "A na-eziga nzaghachi",
    "detector.feedbackSaved": "Ezitere nzaghachi ma chekwaa ya na ihe akụkọ a.",
    "detector.feedbackApiOnly": "Ezitere nzaghachi na API, mana enweghị ike imelite akụkọ mpaghara.",
    "detector.feedbackErrorGeneric": "Enweghị ike izipu nzaghachi.",
    "detector.feedbackErrorChooseAnswer": "Họrọ ee ma ọ bụ mba tupu izipu.",
    "detector.feedbackErrorChooseClass": "Họrọ klas ziri ezi tupu izipu.",
    "detector.feedbackHistoryCorrect": "Nzaghachi: akara amụma dị ka nke ziri ezi.",
    "detector.feedbackHistoryCorrection": "Nzaghachi: emeziri ya ka ọ bụrụ {class}.",
